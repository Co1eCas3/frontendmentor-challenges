 ...
 * status code in the body, pass an empty object ({})
 *   --  responses.success({})
 *   -- // { status: 200, body: { message: 'Success!!' } }
 * 
 * if you'd like to pass a custom message but no other data,
 * can just pass it in as a string as the first argument
 *   --  responses.success('Request was successful!')
 *   -- // { status: 200, body: { message: 'Request was successful!' } }
 * 
 * if you have data to pass, pass it in as the first argument
 * in an object
 *   -- responses.success({ message: 'My message was a success!', data: 'My data' })
 *   -- // { status: 200, body: { message: 'My message was a success!', data: 'My data } }
 * 
